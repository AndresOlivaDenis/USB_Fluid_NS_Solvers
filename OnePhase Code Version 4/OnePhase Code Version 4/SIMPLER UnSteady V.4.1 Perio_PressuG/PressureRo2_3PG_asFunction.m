...
function [p,niteraPE,ErrorPE] = PressureRo2_3PG_asFunction(Nx,Ny,...
...
% =======================================================================
ErrorPE=1; niteraPE=0;  omepc=1.0;
...
while (ErrorPE>=TolP)&&(niteraPE<=nmaxP) % -> Esto es si se usa metodo iterativo!
    ...
    p(2:Nx+1,2)= p(2:Nx+1,Ny) - ...
        dpdy*(yP(2:Nx+1,Ny)-yP(2:Nx+1,2));
    p(2:Nx+1,Ny+1)= p(2:Nx+1,3) - ...
...
%     end
    ...
    % Jacobi
    omepc=0.6;
    p(2:Nx+1,3:Ny) = omepc*1./aPpc(2:Nx+1,3:Ny) .*( ...
        aEpc(2:Nx+1,3:Ny).*pclast(3:Nx+2,3:Ny) + ...
        aWpc(2:Nx+1,3:Ny).*pclast(1:Nx,3:Ny) + ...
        aNpc(2:Nx+1,3:Ny).*pclast(2:Nx+1,4:Ny+1) + ...
        aSpc(2:Nx+1,3:Ny).*pclast(2:Nx+1,2:Ny-1) + bpc(2:Nx+1,3:Ny) ) +...
        (1-omepc)*pclast(2:Nx+1,3:Ny);
    % -.-.-.-.-..-.-.-..-.-.-.-.-.-..-.-.-.-.-.-..-.-.-.-.-.-.-.-..-.-.-.-.
