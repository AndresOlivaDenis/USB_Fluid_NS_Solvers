...
tx(1)=tx(2); ty(1)=-ty(2); tx(NFront+2)=tx(NFront+1); ty(NFront+2)=-ty(NFront+1);
% -----------------------------------------------------------------------
...
%         sftx(2,jyF)=sftx(2,jyF)+STFx(il)/(dxu*dyu)*FIx2(rAx3)*FIy(rAy3);
        sftx(ixF+2,jyF)=sftx(ixF+2,jyF)+STFx(il)/(dxu*dyu)*FIx2(rAx4)*FIy(rAy4);
%         sftx(2,jyF+1)=sftx(2,jyF+1)+STFx(il)/(dxu*dyu)*FIx2(rAx5)*FIy(rAy5);
...
%         sftx(2,jyF-1)=sftx(2,jyF-1)+STFx(il)/(dxu*dyu)*FIx2(rAx9)*FIy2(rAy9);
        sftx(ixF+2,jyF-1)=sftx(ixF+2,jyF-1)+STFx(il)/(dxu*dyu)*FIx2(rAx10)*FIy2(rAy10);
%         sftx(2,jyF+2)=sftx(2,jyF+2)+STFx(il)/(dxu*dyu)*FIx2(rAx11)*FIy2(rAy11);
...
%         sfty(2,jyF)=sfty(2,jyF)+STFy(il)/(dxv*dyv)*FIx2(rAx3)*FIy(rAy3);
        sfty(ixF+2,jyF)=sfty(ixF+2,jyF)+STFy(il)/(dxv*dyv)*FIx2(rAx4)*FIy(rAy4);
%         sfty(2,jyF+1)=sfty(2,jyF+1)+STFy(il)/(dxv*dyv)*FIx2(rAx5)*FIy(rAy5);
...
%         sfty(2,jyF-1)=sfty(2,jyF-1)+STFy(il)/(dxv*dyv)*FIx2(rAx9)*FIy2(rAy9);
        sfty(ixF+2,jyF-1)=sfty(ixF+2,jyF-1)+STFy(il)/(dxv*dyv)*FIx2(rAx10)*FIy2(rAy10);
%         sfty(2,jyF+2)=sfty(2,jyF+2)+STFy(il)/(dxv*dyv)*FIx2(rAx11)*FIy2(rAy11);
