...
Lx = 0.5; X1 = 0; X2 = X1 + Lx;   % [m] Longuitud y Ubicacion de las fronteras
...
h = 40;  
Ny = 2*h; Nx = 0.5*h;           % Numero de nodos
% -------------------------------------------------------------------
...
% Gota --------------------------------------------------------------
rdrop=0.25;xdrop=0.0;ydrop=0.5; % Initial drop size and location
% -------------------------------------------------------------------
