...
%         xmapF=[0.5*(xmapFrontLast(il)+xmapFront(ilNew-1)),...
%             0.5*(xmapFrontLast(il)+xmapFront(ilNew-1)-Lx),...
%             0.5*(xmapFrontLast(il)+xmapFront(ilNew-1)+Lx)];
%         xmapFront(ilNew)=xmapF(idF)-floor(xmapF(idF)/Lx)*Lx;
        xmapF=[0.5*(xmapFrontLast(il)+xmapFront(ilNew-1)),...
            0.5*(xmapFrontLast(il)+xmapFront(ilNew-1)-1),...
            0.5*(xmapFrontLast(il)+xmapFront(ilNew-1)+1)];
