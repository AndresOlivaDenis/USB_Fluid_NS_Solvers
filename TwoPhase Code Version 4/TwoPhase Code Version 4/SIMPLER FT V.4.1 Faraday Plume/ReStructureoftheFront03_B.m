    ...
    while(Asigil==0)
        if (DeltaiFront>=DistFrontLast0)&&(DeltaiFront<DistFrontLast1)
            ...
            if (il0>2)&&(il0<NFront+2)
                xm2=xmapFrontLast(il0-2); xm1=xmapFrontLast(il0-1);
                xM1=xmapFrontLast(il0); xM2=xmapFrontLast(il0+1);
%                 xmapFront(il)=...
...
%                 1/6*u*(u-1)*(u-2)*xmapFrontLast(il0+1);
            ...
            elseif il0==NFront+2
                xm2=xmapFrontLast(il0-2); xm1=xmapFrontLast(il0-1);
                xM1=xmapFrontLast(il0); xM2=xmapFrontLast(3);
%                 xmapFront(il)=...
%                     -1/6*(u-1)*(u-2)*(u-3)*xmapFrontLast(il0-2)+...
%                     0.5*u*(u-2)*(u-3)*xmapFrontLast(il0-1)+...
%                     -0.5*u*(u-1)*(u-3)*xmapFrontLast(il0)+...
%                     1/6*u*(u-1)*(u-2)*xmapFrontLast(3);
            ...
            elseif il0==2
                xm2=xmapFrontLast(NFront); xm1=xmapFrontLast(il0-1);
                xM1=xmapFrontLast(il0); xM2=xmapFrontLast(il0+1);
%                 xmapFront(il)=...
...
%                     1/6*u*(u-1)*(u-2)*xmapFrontLast(il0+1);
                ymapFront(il)=...
                    ...
                    1/6*u*(u-1)*(u-2)*ymapFrontLast(il0+1);
            elseif il0==1
                xm2=xmapFrontLast(NFront-1); xm1=xmapFrontLast(NFront);
                xM1=xmapFrontLast(il0); xM2=xmapFrontLast(il0+1);
%                 xmapFront(il)=...
...
%                     1/6*u*(u-1)*(u-2)*xmapFrontLast(il0+1);
            ...
            % Periodicity for x -----------------------------------------
            [~,idFm2]=min([abs(xm1-xm2),abs(xm1-xm2-1),abs(xm1-xm2+1)]);
            [~,idFM2]=min([abs(xM1-xM2),abs(xM1-xM2-1),abs(xM1-xM2+1)]);
            xlastm2=[xm2,xm2+1,xm2-1]; xlastM2=[xM2,xM2+1,xM2-1];
            xlastm2=[xlastm2(idFm2),xlastm2(idFm2)+1,xlastm2(idFm2)];
            xlastM2=[xlastM2(idFM2),xlastM2(idFM2),xlastM2(idFM2)+1];
            xlastm1=[xm1,xm1+1,xm1]; xlastM1=[xM1,xM1,xM1+1];
            
            xmapFront(il)=...
                -1/6*(u-1)*(u-2)*(u-3)*xlastm2(idF)+...
                0.5*u*(u-2)*(u-3)*xlastm1(idF)+...
                -0.5*u*(u-1)*(u-3)*xlastM1(idF)+...
                1/6*u*(u-1)*(u-2)*xlastM2(idF);
