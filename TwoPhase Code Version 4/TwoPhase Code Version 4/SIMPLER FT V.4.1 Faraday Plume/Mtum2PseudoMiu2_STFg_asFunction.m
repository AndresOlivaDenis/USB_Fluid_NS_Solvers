...
vs(1,:)=v0(Nx+1,:); vs(Nx+2,:)=v0(2,:);
% -----------------------------------------------------------------------
% Normal U Velocity -----------------------------------------------------
us(1,2:Ny+1)=u0(Nx,2:Ny+1)+(dx_Pe(Nx+1,2:Ny+1)+dx_wP(Nx+1,2:Ny+1))...
    ./(dy_sP(Nx,2:Ny+1)+dy_Pn(Nx,2:Ny+1)).*(v0(Nx+1,1:Ny)-v0(Nx+1,2:Ny+1));
us(Nx+1,2:Ny+1)=u0(2,2:Ny+1)+(dx_Pe(2,2:Ny+1)+dx_wP(2,2:Ny+1))...
    ./(dy_sP(2,2:Ny+1)+dy_Pn(2,2:Ny+1)).*(v0(2,2:Ny+1)-v0(2,1:Ny));
% -----------------------------------------------------------------------
% Normal v Velocity -----------------------------------------------------
...
[us,vs] = Velocities_BC_Perio(vCBsouth, vCBnorth,...
...
%     % ------------------- Periodicity ------------------- %
%     % Tangential V Velocity
%     vs(1,:)=vs(Nx+1,:); vs(Nx+2,:)=vs(2,:);
%     % Normal U Velocity
%     us(1,2:Ny+1)=us(Nx,2:Ny+1)+(dx_Pe(Nx+1,2:Ny+1)+dx_wP(Nx+1,2:Ny+1))...
%         ./(dy_sP(Nx,2:Ny+1)+dy_Pn(Nx,2:Ny+1)).*(vs(Nx+1,1:Ny)-vs(Nx+1,2:Ny+1));
%     us(Nx+1,2:Ny+1)=us(2,2:Ny+1)+(dx_Pe(2,2:Ny+1)+dx_wP(2,2:Ny+1))...
%         ./(dy_sP(2,2:Ny+1)+dy_Pn(2,2:Ny+1)).*(vs(2,2:Ny+1)-vs(2,1:Ny));
%     % --------------------------------------------------- %
%     % Normal Velocity
...
% us(1,2:Ny+1)=0.5*(us(1,2:Ny+1)+us(Nx+1,2:Ny+1)); us(Nx+1,2:Ny+1)=us(1,2:Ny+1);
%     
%     %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
