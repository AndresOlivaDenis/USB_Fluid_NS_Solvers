...
% Polinomio Cubico!
% A=2.25; FMx=@(psi) psi+A*psi.*(1-psi)*(0.5-psi); % Nodos espaciados hacia la mitad! 
% A=1.5; FMy=@(psi) psi+A*psi.*(1-psi)*(0.5-psi); % Nodos espaciados hacia la mitad! 
...
% =======================================================================
% figure; plot([1:Nx+2]',xP(:,1),'-o',[1:Nx+1]',xu(:,1),'o',[1:Nx+2]',xv(:,1),'o')
% legend('Escalar','u','v'); title('Espaciamiento en x'); xlabel('Nx'); ylabel('x')
% figure; plot([1:Ny+2]',yP(1,:),'-o',[1:Ny+2]',yu(1,:),'o',[1:Ny+1]',yv(1,:),'o')
% legend('Escalar','u','v'); title('Espaciamiento en y'); xlabel('Ny'); ylabel('y')
% 
% figure; plot(psi(1:end-1),xi,psi(1:end-1),xi,'o','linewidth',2); 
% xlabel('epsi'); ylabel('x'); hold on;
% for i=1:Nx
%     plot([psi(i),psi(i)],[0,xi(i)],'k','linewidth',0.001);
% end
% for i=1:Nx
%     plot([0,psi(i)],[xi(i),xi(i)],'k','linewidth',0.001);
% end
% =======================================================================
