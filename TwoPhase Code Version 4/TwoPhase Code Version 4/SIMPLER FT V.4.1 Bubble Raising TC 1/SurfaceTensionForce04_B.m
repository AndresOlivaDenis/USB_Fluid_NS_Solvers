...
for il=2:NFront+1
    ...
    sftx(ixF-1,jyF)=sftx(ixF-1,jyF)+STFx(il)/(dxu*dyu)*FIx(rAx3)*FIy(rAy3);
    sftx(ixF+2,jyF)=sftx(ixF+2,jyF)+STFx(il)/(dxu*dyu)*FIx(rAx4)*FIy(rAy4);
    sftx(ixF-1,jyF+1)=sftx(ixF-1,jyF+1)+STFx(il)/(dxu*dyu)*FIx(rAx5)*FIy(rAy5);
    sftx(ixF+2,jyF+1)=sftx(ixF+2,jyF+1)+STFx(il)/(dxu*dyu)*FIx(rAx6)*FIy(rAy6);
    ...
    sftx(ixF-1,jyF-1)=sftx(ixF-1,jyF-1)+STFx(il)/(dxu*dyu)*FIx(rAx9)*FIy(rAy9);
    sftx(ixF+2,jyF-1)=sftx(ixF+2,jyF-1)+STFx(il)/(dxu*dyu)*FIx(rAx10)*FIy(rAy10);
    sftx(ixF-1,jyF+2)=sftx(ixF-1,jyF+2)+STFx(il)/(dxu*dyu)*FIx(rAx11)*FIy(rAy11);
    sftx(ixF+2,jyF+2)=sftx(ixF+2,jyF+2)+STFx(il)/(dxu*dyu)*FIx(rAx12)*FIy(rAy12);
    % -------------------------------------------------------------------
    ...
    sfty(ixF-1,jyF)=sfty(ixF-1,jyF)+STFy(il)/(dxv*dyv)*FIx(rAx3)*FIy(rAy3);
    sfty(ixF+2,jyF)=sfty(ixF+2,jyF)+STFy(il)/(dxv*dyv)*FIx(rAx4)*FIy(rAy4);
    sfty(ixF-1,jyF+1)=sfty(ixF-1,jyF+1)+STFy(il)/(dxv*dyv)*FIx(rAx5)*FIy(rAy5);
    sfty(ixF+2,jyF+1)=sfty(ixF+2,jyF+1)+STFy(il)/(dxv*dyv)*FIx(rAx6)*FIy(rAy6);
    ...
    sfty(ixF-1,jyF-1)=sfty(ixF-1,jyF-1)+STFy(il)/(dxv*dyv)*FIx(rAx9)*FIy(rAy9);
    sfty(ixF+2,jyF-1)=sfty(ixF+2,jyF-1)+STFy(il)/(dxv*dyv)*FIx(rAx10)*FIy(rAy10);
    sfty(ixF-1,jyF+2)=sfty(ixF-1,jyF+2)+STFy(il)/(dxv*dyv)*FIx(rAx11)*FIy(rAy11);
    sfty(ixF+2,jyF+2)=sfty(ixF+2,jyF+2)+STFy(il)/(dxv*dyv)*FIx(rAx12)*FIy(rAy12);
    % -------------------------------------------------------------------
end
% =======================================================================
