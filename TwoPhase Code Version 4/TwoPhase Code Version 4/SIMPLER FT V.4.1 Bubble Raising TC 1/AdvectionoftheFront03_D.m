...
function [xFront,yFront,uFront,vFront,...
    ...
    =AdvectionoftheFront03_D(NFront0,xFront0,yFront0,...
...
for il=1:NFront0+2
    ...
    uFront(il)=u(ixF,jyF)*FIx(rx1)*FIy(ry1)+u(ixF+1,jyF)*FIx(rx2)*FIy(ry2)+...
        ...
        u(ixF-1,jyF)*FIx2(rAx3)*FIy(rAy3)+u(ixF+2,jyF)*FIx2(rAx4)*FIy(rAy4)+...
        u(ixF-1,jyF+1)*FIx2(rAx5)*FIy(rAy5)+u(ixF+2,jyF+1)*FIx2(rAx6)*FIy(rAy6)+...
        u(ixF,jyF+2)*FIx(rAx7)*FIy2(rAy7)+u(ixF+1,jyF+2)*FIx(rAx8)*FIy2(rAy8)+...
        u(ixF-1,jyF-1)*FIx2(rAx9)*FIy2(rAy9)+u(ixF+2,jyF-1)*FIx2(rAx10)*FIy2(rAy10)+...
        u(ixF-1,jyF+2)*FIx2(rAx11)*FIy2(rAy11)+u(ixF+2,jyF+2)*FIx2(rAx12)*FIy2(rAy12);
    ...
    uFront0(il)=u0(ixF,jyF)*FIx(rx1)*FIy(ry1)+u0(ixF+1,jyF)*FIx(rx2)*FIy(ry2)+...
        ...
        u0(ixF-1,jyF)*FIx2(rAx3)*FIy(rAy3)+u0(ixF+2,jyF)*FIx2(rAx4)*FIy(rAy4)+...
        u0(ixF-1,jyF+1)*FIx2(rAx5)*FIy(rAy5)+u0(ixF+2,jyF+1)*FIx2(rAx6)*FIy(rAy6)+...
        u0(ixF,jyF+2)*FIx(rAx7)*FIy2(rAy7)+u0(ixF+1,jyF+2)*FIx(rAx8)*FIy2(rAy8)+...
        u0(ixF-1,jyF-1)*FIx2(rAx9)*FIy2(rAy9)+u0(ixF+2,jyF-1)*FIx2(rAx10)*FIy2(rAy10)+...
        u0(ixF-1,jyF+2)*FIx2(rAx11)*FIy2(rAy11)+u0(ixF+2,jyF+2)*FIx2(rAx12)*FIy2(rAy12);
    ...
    vFront(il)=v(ixF,jyF)*FIx(rx1)*FIy(ry1)+v(ixF+1,jyF)*FIx(rx2)*FIy(ry2)+...
        ...
        v(ixF-1,jyF)*FIx2(rAx3)*FIy(rAy3)+v(ixF+2,jyF)*FIx2(rAx4)*FIy(rAy4)+...
        v(ixF-1,jyF+1)*FIx2(rAx5)*FIy(rAy5)+v(ixF+2,jyF+1)*FIx2(rAx6)*FIy(rAy6)+...
        v(ixF,jyF+2)*FIx(rAx7)*FIy2(rAy7)+v(ixF+1,jyF+2)*FIx(rAx8)*FIy2(rAy8)+...
        v(ixF-1,jyF-1)*FIx2(rAx9)*FIy2(rAy9)+v(ixF+2,jyF-1)*FIx2(rAx10)*FIy2(rAy10)+...
        v(ixF-1,jyF+2)*FIx2(rAx11)*FIy2(rAy11)+v(ixF+2,jyF+2)*FIx2(rAx12)*FIy2(rAy12);
    ...
    vFront0(il)=v0(ixF,jyF)*FIx(rx1)*FIy(ry1)+v0(ixF+1,jyF)*FIx(rx2)*FIy(ry2)+...
        ...
        v0(ixF-1,jyF)*FIx2(rAx3)*FIy(rAy3)+v0(ixF+2,jyF)*FIx2(rAx4)*FIy(rAy4)+...
        v0(ixF-1,jyF+1)*FIx2(rAx5)*FIy(rAy5)+v0(ixF+2,jyF+1)*FIx2(rAx6)*FIy(rAy6)+...
        v0(ixF,jyF+2)*FIx(rAx7)*FIy2(rAy7)+v0(ixF+1,jyF+2)*FIx(rAx8)*FIy2(rAy8)+...
        v0(ixF-1,jyF-1)*FIx2(rAx9)*FIy2(rAy9)+v0(ixF+2,jyF-1)*FIx2(rAx10)*FIy2(rAy10)+...
        v0(ixF-1,jyF+2)*FIx2(rAx11)*FIy2(rAy11)+v0(ixF+2,jyF+2)*FIx2(rAx12)*FIy2(rAy12);
