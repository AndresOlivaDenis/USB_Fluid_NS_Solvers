...
for il=2:NFront+1
    ...
    MarkFdx(ixF-1,jyF)=MarkFdx(ixF-1,jyF)+nfx/(dxu*dyu)*FIx(rAx3)*FIy(rAy3);
    MarkFdx(ixF+2,jyF)=MarkFdx(ixF+2,jyF)+nfx/(dxu*dyu)*FIx(rAx4)*FIy(rAy4);
    MarkFdx(ixF-1,jyF+1)=MarkFdx(ixF-1,jyF+1)+nfx/(dxu*dyu)*FIx(rAx5)*FIy(rAy5);
    MarkFdx(ixF+2,jyF+1)=MarkFdx(ixF+2,jyF+1)+nfx/(dxu*dyu)*FIx(rAx6)*FIy(rAy6);
    ...
    MarkFdx(ixF-1,jyF-1)=MarkFdx(ixF-1,jyF-1)+nfx/(dxu*dyu)*FIx(rAx9)*FIy(rAy9);
    MarkFdx(ixF+2,jyF-1)=MarkFdx(ixF+2,jyF-1)+nfx/(dxu*dyu)*FIx(rAx10)*FIy(rAy10);
    MarkFdx(ixF-1,jyF+2)=MarkFdx(ixF-1,jyF+2)+nfx/(dxu*dyu)*FIx(rAx11)*FIy(rAy11);
    MarkFdx(ixF+2,jyF+2)=MarkFdx(ixF+2,jyF+2)+nfx/(dxu*dyu)*FIx(rAx12)*FIy(rAy12);
    % -------------------------------------------------------------------
    ...
    MarkFdy(ixF-1,jyF)=MarkFdy(ixF-1,jyF)+nfy/(dxv*dyv)*FIx(rAx3)*FIy(rAy3);
    MarkFdy(ixF+2,jyF)=MarkFdy(ixF+2,jyF)+nfy/(dxv*dyv)*FIx(rAx4)*FIy(rAy4);
    MarkFdy(ixF-1,jyF+1)=MarkFdy(ixF-1,jyF+1)+nfy/(dxv*dyv)*FIx(rAx5)*FIy(rAy5);
    MarkFdy(ixF+2,jyF+1)=MarkFdy(ixF+2,jyF+1)+nfy/(dxv*dyv)*FIx(rAx6)*FIy(rAy6);
    ...
    MarkFdy(ixF-1,jyF-1)=MarkFdy(ixF-1,jyF-1)+nfy/(dxv*dyv)*FIx(rAx9)*FIy(rAy9);
    MarkFdy(ixF+2,jyF-1)=MarkFdy(ixF+2,jyF-1)+nfy/(dxv*dyv)*FIx(rAx10)*FIy(rAy10);
    MarkFdy(ixF-1,jyF+2)=MarkFdy(ixF-1,jyF+2)+nfy/(dxv*dyv)*FIx(rAx11)*FIy(rAy11);
    MarkFdy(ixF+2,jyF+2)=MarkFdy(ixF+2,jyF+2)+nfy/(dxv*dyv)*FIx(rAx12)*FIy(rAy12);
    % -------------------------------------------------------------------
