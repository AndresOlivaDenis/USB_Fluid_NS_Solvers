...
for il=1:NFront0+2
    ...
    uFront(il)=u(ixF,jyF)*FIx(rx1)*FIy(ry1)+u(ixF+1,jyF)*FIx(rx2)*FIy(ry2)+...
        ...
        u(ixFA1,jyF)*FIx(rAx3)*FIy(rAy3)+u(ixFA2,jyF)*FIx(rAx4)*FIy(rAy4)+...
        u(ixFA1,jyF+1)*FIx(rAx5)*FIy(rAy5)+u(ixFA2,jyF+1)*FIx(rAx6)*FIy(rAy6)+...
        u(ixF,jyF+2)*FIx(rAx7)*FIy(rAy7)+u(ixF+1,jyF+2)*FIx(rAx8)*FIy(rAy8)+...
        u(ixFA1,jyF-1)*FIx(rAx9)*FIy(rAy9)+u(ixFA2,jyF-1)*FIx(rAx10)*FIy(rAy10)+...
        u(ixFA1,jyF+2)*FIx(rAx11)*FIy(rAy11)+u(ixFA2,jyF+2)*FIx(rAx12)*FIy(rAy12);
    ...
    uFront0(il)=u0(ixF,jyF)*FIx(rx1)*FIy(ry1)+u0(ixF+1,jyF)*FIx(rx2)*FIy(ry2)+...
        ...
        u0(ixFA1,jyF)*FIx(rAx3)*FIy(rAy3)+u0(ixFA2,jyF)*FIx(rAx4)*FIy(rAy4)+...
        u0(ixFA1,jyF+1)*FIx(rAx5)*FIy(rAy5)+u0(ixFA2,jyF+1)*FIx(rAx6)*FIy(rAy6)+...
        u0(ixF,jyF+2)*FIx(rAx7)*FIy(rAy7)+u0(ixF+1,jyF+2)*FIx(rAx8)*FIy(rAy8)+...
        u0(ixFA1,jyF-1)*FIx(rAx9)*FIy(rAy9)+u0(ixFA2,jyF-1)*FIx(rAx10)*FIy(rAy10)+...
        u0(ixFA1,jyF+2)*FIx(rAx11)*FIy(rAy11)+u0(ixFA2,jyF+2)*FIx(rAx12)*FIy(rAy12);
    ...
    vFront(il)=v(ixF,jyF)*FIx(rx1)*FIy(ry1)+v(ixF+1,jyF)*FIx(rx2)*FIy(ry2)+...
        ...
        v(ixFA1,jyF)*FIx(rAx3)*FIy(rAy3)+v(ixFA2,jyF)*FIx(rAx4)*FIy(rAy4)+...
        v(ixFA1,jyF+1)*FIx(rAx5)*FIy(rAy5)+v(ixFA2,jyF+1)*FIx(rAx6)*FIy(rAy6)+...
        v(ixF,jyF+2)*FIx(rAx7)*FIy(rAy7)+v(ixF+1,jyF+2)*FIx(rAx8)*FIy(rAy8)+...
        v(ixFA1,jyF-1)*FIx(rAx9)*FIy(rAy9)+v(ixFA2,jyF-1)*FIx(rAx10)*FIy(rAy10)+...
        v(ixFA1,jyF+2)*FIx(rAx11)*FIy(rAy11)+v(ixFA2,jyF+2)*FIx(rAx12)*FIy(rAy12);
    ...
    vFront0(il)=v0(ixF,jyF)*FIx(rx1)*FIy(ry1)+v0(ixF+1,jyF)*FIx(rx2)*FIy(ry2)+...
        ...
        v0(ixFA1,jyF)*FIx(rAx3)*FIy(rAy3)+v0(ixFA2,jyF)*FIx(rAx4)*FIy(rAy4)+...
        v0(ixFA1,jyF+1)*FIx(rAx5)*FIy(rAy5)+v0(ixFA2,jyF+1)*FIx(rAx6)*FIy(rAy6)+...
        v0(ixF,jyF+2)*FIx(rAx7)*FIy(rAy7)+v0(ixF+1,jyF+2)*FIx(rAx8)*FIy(rAy8)+...
        v0(ixFA1,jyF-1)*FIx(rAx9)*FIy(rAy9)+v0(ixFA2,jyF-1)*FIx(rAx10)*FIy(rAy10)+...
        v0(ixFA1,jyF+2)*FIx(rAx11)*FIy(rAy11)+v0(ixFA2,jyF+2)*FIx(rAx12)*FIy(rAy12);
