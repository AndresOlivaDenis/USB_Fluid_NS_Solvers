...
for il=2:NFront+1
    ...
    MarkFdx(ixFA1,jyF)=MarkFdx(ixFA1,jyF)+nfx/(dxu*dyu)*FIx2(rAx3)*FIy(rAy3);
    MarkFdx(ixFA2,jyF)=MarkFdx(ixFA2,jyF)+nfx/(dxu*dyu)*FIx2(rAx4)*FIy(rAy4);
    MarkFdx(ixFA1,jyF+1)=MarkFdx(ixFA1,jyF+1)+nfx/(dxu*dyu)*FIx2(rAx5)*FIy(rAy5);
    MarkFdx(ixFA2,jyF+1)=MarkFdx(ixFA2,jyF+1)+nfx/(dxu*dyu)*FIx2(rAx6)*FIy(rAy6);
    ...
    MarkFdx(ixFA1,jyF-1)=MarkFdx(ixFA1,jyF-1)+nfx/(dxu*dyu)*FIx2(rAx9)*FIy2(rAy9);
    MarkFdx(ixFA2,jyF-1)=MarkFdx(ixFA2,jyF-1)+nfx/(dxu*dyu)*FIx2(rAx10)*FIy2(rAy10);
    MarkFdx(ixFA1,jyF+2)=MarkFdx(ixFA1,jyF+2)+nfx/(dxu*dyu)*FIx2(rAx11)*FIy2(rAy11);
    MarkFdx(ixFA2,jyF+2)=MarkFdx(ixFA2,jyF+2)+nfx/(dxu*dyu)*FIx2(rAx12)*FIy2(rAy12);
    % -------------------------------------------------------------------
    ...
    MarkFdy(ixFA1,jyF)=MarkFdy(ixFA1,jyF)+nfy/(dxv*dyv)*FIx2(rAx3)*FIy(rAy3);
    MarkFdy(ixFA2,jyF)=MarkFdy(ixFA2,jyF)+nfy/(dxv*dyv)*FIx2(rAx4)*FIy(rAy4);
    MarkFdy(ixFA1,jyF+1)=MarkFdy(ixFA1,jyF+1)+nfy/(dxv*dyv)*FIx2(rAx5)*FIy(rAy5);
    MarkFdy(ixFA2,jyF+1)=MarkFdy(ixFA2,jyF+1)+nfy/(dxv*dyv)*FIx2(rAx6)*FIy(rAy6);
    ...
    MarkFdy(ixFA1,jyF-1)=MarkFdy(ixFA1,jyF-1)+nfy/(dxv*dyv)*FIx2(rAx9)*FIy2(rAy9);
    MarkFdy(ixFA2,jyF-1)=MarkFdy(ixFA2,jyF-1)+nfy/(dxv*dyv)*FIx2(rAx10)*FIy2(rAy10);
    MarkFdy(ixFA1,jyF+2)=MarkFdy(ixFA1,jyF+2)+nfy/(dxv*dyv)*FIx2(rAx11)*FIy2(rAy11);
    MarkFdy(ixFA2,jyF+2)=MarkFdy(ixFA2,jyF+2)+nfy/(dxv*dyv)*FIx2(rAx12)*FIy2(rAy12);
    % -------------------------------------------------------------------
