...
function [sftx,sfty] = SurfaceTensionForce04_C(Nx,Ny,sigma,...
...
%     ixF=floor(xmapFront(il)*Nx+1); jyF=floor(ymapFront(il)*Ny+1+0.5);
    ...
    sftx(ixFA1,jyF)=sftx(ixFA1,jyF)+STFx(il)/(dxu*dyu)*FIx2(rAx3)*FIy(rAy3);
    sftx(ixFA2,jyF)=sftx(ixFA2,jyF)+STFx(il)/(dxu*dyu)*FIx2(rAx4)*FIy(rAy4);
    sftx(ixFA1,jyF+1)=sftx(ixFA1,jyF+1)+STFx(il)/(dxu*dyu)*FIx2(rAx5)*FIy(rAy5);
    sftx(ixFA2,jyF+1)=sftx(ixFA2,jyF+1)+STFx(il)/(dxu*dyu)*FIx2(rAx6)*FIy(rAy6);
    ...
    sftx(ixFA1,jyF-1)=sftx(ixFA1,jyF-1)+STFx(il)/(dxu*dyu)*FIx2(rAx9)*FIy2(rAy9);
    sftx(ixFA2,jyF-1)=sftx(ixFA2,jyF-1)+STFx(il)/(dxu*dyu)*FIx2(rAx10)*FIy2(rAy10);
    sftx(ixFA1,jyF+2)=sftx(ixFA1,jyF+2)+STFx(il)/(dxu*dyu)*FIx2(rAx11)*FIy2(rAy11);
    sftx(ixFA2,jyF+2)=sftx(ixFA2,jyF+2)+STFx(il)/(dxu*dyu)*FIx2(rAx12)*FIy2(rAy12);
    % --------------------------------------------------------------------
...
%     ixF=floor(xmapFront(il)*Nx+1+0.5); jyF=floor(ymapFront(il)*Ny+1);
    ...
    sfty(ixFA1,jyF)=sfty(ixFA1,jyF)+STFy(il)/(dxv*dyv)*FIx2(rAx3)*FIy(rAy3);
    sfty(ixFA2,jyF)=sfty(ixFA2,jyF)+STFy(il)/(dxv*dyv)*FIx2(rAx4)*FIy(rAy4);
    sfty(ixFA1,jyF+1)=sfty(ixFA1,jyF+1)+STFy(il)/(dxv*dyv)*FIx2(rAx5)*FIy(rAy5);
    sfty(ixFA2,jyF+1)=sfty(ixFA2,jyF+1)+STFy(il)/(dxv*dyv)*FIx2(rAx6)*FIy(rAy6);
    ...
    sfty(ixFA1,jyF-1)=sfty(ixFA1,jyF-1)+STFy(il)/(dxv*dyv)*FIx2(rAx9)*FIy2(rAy9);
    sfty(ixFA2,jyF-1)=sfty(ixFA2,jyF-1)+STFy(il)/(dxv*dyv)*FIx2(rAx10)*FIy2(rAy10);
    sfty(ixFA1,jyF+2)=sfty(ixFA1,jyF+2)+STFy(il)/(dxv*dyv)*FIx2(rAx11)*FIy2(rAy11);
    sfty(ixFA2,jyF+2)=sfty(ixFA2,jyF+2)+STFy(il)/(dxv*dyv)*FIx2(rAx12)*FIy2(rAy12);
    % -----------------------------------------------------------------------
